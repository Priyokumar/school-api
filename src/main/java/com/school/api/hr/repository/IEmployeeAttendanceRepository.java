...
public interface IEmployeeAttendanceRepository extends CrudRepository<EmployeeAttendance, String> {
	...
	public Optional<EmployeeAttendance> findAttendanceByEmpAndDate(@Param("date") Date date, @Param("empId") String empId);
	...
	public List<EmployeeAttendance> findAttendanceReport(
